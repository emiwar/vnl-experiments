...
Run it
------
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-budgets/extract.py       # frozen
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-budgets/extract.py --refresh
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-budgets/extract.py --check
"""
