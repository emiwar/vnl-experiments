...
*Reproduce:* `../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-budgets/extract.py && ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-budgets/plot.py`
