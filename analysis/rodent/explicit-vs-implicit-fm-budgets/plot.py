...
Run from the repo root::
    ...
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-budgets/plot.py
    VNL_NO_FOOTER=1 ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-budgets/plot.py
