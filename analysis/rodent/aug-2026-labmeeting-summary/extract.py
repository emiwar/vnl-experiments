...
Run it
------
    ../.venv/bin/python analysis/rodent/aug-2026-labmeeting-summary/extract.py
    ../.venv/bin/python analysis/rodent/aug-2026-labmeeting-summary/extract.py --refresh
    ../.venv/bin/python analysis/rodent/aug-2026-labmeeting-summary/extract.py --check
    ../.venv/bin/python analysis/rodent/aug-2026-labmeeting-summary/extract.py --part groups --redecode
