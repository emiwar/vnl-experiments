...
```
../.venv/bin/python analysis/rodent/aug-2026-labmeeting-summary/extract.py     # frozen, ~40 s
../.venv/bin/python analysis/rodent/aug-2026-labmeeting-summary/plot.py
```
...
python -m vnl_experiments.artifacts plan --kind eval \
    --runs analysis/rodent/aug-2026-labmeeting-summary/runs.csv --set action_noise=0.02
