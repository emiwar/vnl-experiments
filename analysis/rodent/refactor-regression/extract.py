...
Run it
------
    ../.venv/bin/python analysis/rodent/refactor-regression/extract.py            # frozen rebuild
    ../.venv/bin/python analysis/rodent/refactor-regression/extract.py --sync --refresh
    ../.venv/bin/python analysis/rodent/refactor-regression/extract.py --check
"""
