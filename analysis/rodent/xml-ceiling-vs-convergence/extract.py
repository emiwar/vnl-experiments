...
Run it
------
    ../.venv/bin/python analysis/rodent/xml-ceiling-vs-convergence/extract.py           # frozen
    ../.venv/bin/python analysis/rodent/xml-ceiling-vs-convergence/extract.py --refresh
    ../.venv/bin/python analysis/rodent/xml-ceiling-vs-convergence/extract.py --check
"""
