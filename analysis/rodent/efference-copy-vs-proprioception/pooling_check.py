...
the crashed runs can still say something.
    ...
    ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/pooling_check.py
    ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/pooling_check.py --check
