...
*Reproduce:* `../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/extract.py && ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/plot.py`
