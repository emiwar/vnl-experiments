...
presented as the other.
    ...
    ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/code_identity.py
    ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/code_identity.py --check
