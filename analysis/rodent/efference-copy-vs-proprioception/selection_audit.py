...
``extract.py`` stops being a free lunch.
    ...
    ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/selection_audit.py
    ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/selection_audit.py --check
