...
Run it
------
    ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/extract.py
    ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/extract.py --sync --refresh
    ../.venv/bin/python analysis/rodent/efference-copy-vs-proprioception/extract.py --check
