...
reward of both arms.
    ...
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-probe/plot.py
    VNL_NO_FOOTER=1 ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-probe/plot.py
"""
