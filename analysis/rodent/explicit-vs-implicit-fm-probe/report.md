...
*Reproduce:* `../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-probe/extract.py && ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-probe/plot.py`
