...
This re-asks the question of ``analysis/rodent/implicit-forward-model/`` on the current setting --
...
Run it
------
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-probe/extract.py            # frozen
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-probe/extract.py --select-only
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-probe/extract.py --sync --refresh
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-probe/extract.py --redecode --jobs 4
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-probe/extract.py --check
...
def main() -> None:
    ...
    runs = pipeline.resolve_selection(HERE, CONDITIONS, refresh=parser_args.refresh,
                                      sync=parser_args.sync, project=parser_args.project or PROJECT)
    runs = runs.merge(index.load(project=parser_args.project or PROJECT),
