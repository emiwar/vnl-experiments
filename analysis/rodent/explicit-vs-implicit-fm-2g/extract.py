...
Run it
------
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-2g/extract.py           # frozen
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-2g/extract.py --refresh
    ../.venv/bin/python analysis/rodent/explicit-vs-implicit-fm-2g/extract.py --check
"""
...
def main() -> None:
    ...
    index_frame = index_module.load(args.project or PROJECT).set_index("wandb_id")
