...
Run it
------
    ../.venv/bin/python analysis/rodent/recurrent-decoder-preliminary/extract.py
    ../.venv/bin/python analysis/rodent/recurrent-decoder-preliminary/extract.py --sync --refresh
"""
