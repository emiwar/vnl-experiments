...
Run it
------
    ../.venv/bin/python analysis/rodent/collision-model-xml/extract.py           # frozen
    ../.venv/bin/python analysis/rodent/collision-model-xml/extract.py --refresh
    ../.venv/bin/python analysis/rodent/collision-model-xml/extract.py --check
"""
