"""Plot the explicit-forward-model comparison from data.csv.

Run from the repo root::

    ../.venv/bin/python analysis/rodent/explicit-forward-model/plot.py
...
# Forward model is the subject of the question, so it leads the legend.
ORDER = ["forward_model", "efference", "no_efference"]
...
def main() -> None:
    ...
    out = FIGURES / "forward_model_comparison.png"
    fig.savefig(out)
    print(f"Saved {out}")
