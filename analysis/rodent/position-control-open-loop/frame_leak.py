...
shows up as an exact zero.
    ...
    ../.venv/bin/python analysis/rodent/position-control-open-loop/frame_leak.py
    ../.venv/bin/python analysis/rodent/position-control-open-loop/frame_leak.py --check
