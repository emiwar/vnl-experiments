...
trained weights.
    ...
    ../.venv/bin/python analysis/rodent/position-control-open-loop/check_delay_inert.py
    ../.venv/bin/python analysis/rodent/position-control-open-loop/check_delay_inert.py --check
