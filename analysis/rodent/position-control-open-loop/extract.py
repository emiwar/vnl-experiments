...
Run it
------
    ../.venv/bin/python analysis/rodent/position-control-open-loop/extract.py            # frozen
    ../.venv/bin/python analysis/rodent/position-control-open-loop/extract.py --refresh
    ../.venv/bin/python analysis/rodent/position-control-open-loop/extract.py --check
"""
