...
1. **One batch V3 offline eval over the whole cohort** — 92 of the 101 runs lack it. That
   ...
   `artifacts plan --kind eval --runs analysis/rodent/position-control-open-loop/runs.csv --out todo.txt`,
...
*Reproduce:*
`../.venv/bin/python analysis/rodent/position-control-open-loop/extract.py && ../.venv/bin/python analysis/rodent/position-control-open-loop/plot.py`
...
all under `analysis/rodent/position-control-open-loop/`.
