...
that leaves.
    ...
    ../.venv/bin/python analysis/rodent/position-control-open-loop/actuator_map.py
    ../.venv/bin/python analysis/rodent/position-control-open-loop/actuator_map.py --check
