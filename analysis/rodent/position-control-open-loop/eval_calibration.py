...
the V3 bump was for, and evidence the partition is doing its job rather than noise.
    ...
    ../.venv/bin/python analysis/rodent/position-control-open-loop/eval_calibration.py
    ../.venv/bin/python analysis/rodent/position-control-open-loop/eval_calibration.py --check
