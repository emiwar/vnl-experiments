...
Run it
------
    ../.venv/bin/python analysis/rodent/<question-slug>/extract.py            # frozen rebuild
    ../.venv/bin/python analysis/rodent/<question-slug>/extract.py --sync --refresh
    ../.venv/bin/python analysis/rodent/<question-slug>/extract.py --check    # CI-style drift check
...
def main() -> None:
    ...
    # `or PROJECT`: --project has no default, so the project this folder analyses is the
    # one pinned above rather than whatever the shared default happens to be.
