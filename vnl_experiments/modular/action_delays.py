...
config = TrainConfig(
    ppo=PPOConfig(
        ...
        weight_decay=None,
        logging_level=LoggingLevel.LOSSES | LoggingLevel.ROLLOUT_STATS | LoggingLevel.ENV_METRICS | LoggingLevel.NETWORK_METRICS | LoggingLevel.CRITIC_EXTRA,
...
train_env = ActionDelayWrapper(train_env, env_config.action_delay)
eval_env = ActionDelayWrapper(eval_env, env_config.action_delay)
